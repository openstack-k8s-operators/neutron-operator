...
ARG IMAGE_COMPONENT="neutron-operator-container"
ARG IMAGE_NAME="neutron-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Neutron Operator"
ARG IMAGE_DESC="This image includes the neutron-operator"

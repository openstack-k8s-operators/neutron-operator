...
require (
	...
	github.com/openstack-k8s-operators/ovn-operator/api v0.3.1-0.20231219105103-9bf7c255dfe5
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.3.1-0.20231219100655-bf6e709d8019 // indirect

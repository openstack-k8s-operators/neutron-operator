...
require (
	...
	github.com/openstack-k8s-operators/keystone-operator v0.0.0-20220812060356-3949bac143d1 // indirect
	github.com/openstack-k8s-operators/lib-common/modules/database v0.0.0-20220815134439-d6da0e6d56cf // indirect

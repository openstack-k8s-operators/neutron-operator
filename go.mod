...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/test v0.3.1-0.20240313150019-749b817f2f32
	github.com/openstack-k8s-operators/mariadb-operator/api v0.3.1-0.20240313161858-fb6e8132bae9
	github.com/openstack-k8s-operators/neutron-operator/api v0.0.0-00010101000000-000000000000
	github.com/openstack-k8s-operators/ovn-operator/api v0.3.1-0.20240311052444-d7d87d32513e
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.3.1-0.20240313150019-749b817f2f32 // indirect

...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/storage v0.6.1-0.20250505061650-7cb2f323fb35
	github.com/openstack-k8s-operators/lib-common/modules/test v0.6.1-0.20250505061650-7cb2f323fb35

...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NeutronRoute) DeepCopyInto(out *NeutronRoute) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NeutronRoute.
func (in *NeutronRoute) DeepCopy() *NeutronRoute {
	if in == nil {
		return nil
	}
	out := new(NeutronRoute)
	in.DeepCopyInto(out)
	return out
}

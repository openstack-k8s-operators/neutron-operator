...
func UpdateStatusHash(r ReconcilerCommon, obj runtime.Object, hashes *[]neutronv1beta1.Hash, newHashes []neutronv1beta1.Hash) error {
	update := false
